...
//	private String banco = "transportadora"; // nome do BD
	...
	public Conexao() throws ClassNotFoundException, SQLException  {
		...
		conexao = DriverManager.getConnection("jdbc:mysql://localhost:3306/transportadora?useTimezone=true&serverTimezone=America/Sao_Paulo", this.login, this.senha);
